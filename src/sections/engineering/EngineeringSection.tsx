      ...
      <Container>
        ...
        <div ref={headerRef} className="mb-16 md:mb-24">
          ...
          >
            ...
            >
              Frontend<br className="hidden md:block" /> Engineering
            </h2>

            <p className="text-body text-muted-foreground max-w-md">
              I don't just write frontend code. I engineer complete interfaces and applications.
            </p>
          </motion.div>
        ...
        >
          {engineeringCategories.map((category, i) => (
            <EngineeringCategory
              key={category.id}
              category={category}
              index={i}
